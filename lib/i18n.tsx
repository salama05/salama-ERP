...
const translations: Record<Language, TranslationDictionary> = {
  ...
  ar: {
    ...
    remainingDebt: "المتبقي من الكريدي",
    ...
    maxCreditLimit: "الحد الأقصى للكريدي",
    ...
    heroTitle: "نظام تشغيل أكثر تطورا للتجار.",
    heroDesc: "أدر المنتجات والفواتير والزبائن والموردين ونقطة البيع والمالية والتحليلات من مساحة عمل متعددة المستأجرين مبنية للسرعة والوضوح ودعم الكتابة من اليمين إلى اليسار.",
    ...
    dashboardPreviewRtlNote: "مُصمم لدعم العربية والفرنسية والإنجليزية منذ البداية.",
    ...
    authFeatureRtlTitle: "جاهز للعربية",
